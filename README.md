# Quant Internship List

## maintainer

Tai Karir • [GitHub](https://github.com/taikarir) • [LinkedIn](https://www.linkedin.com/in/tai-karir-7447bb25b/)

## content

- covers ~60 quant firms
- covers trading, research, quant dev, and SWE roles
- only searches for US-based positions
- list is updated daily through GitHub actions
- roles are LLM-generated so different text may be generated for the same role on a different day.
...
- **2027 Quantitative Prediction Markets Research Summer Analyst**
  - **Internship role focused on quantitative research in prediction markets.**
- **2027 Research Summer Analyst**
  - **Internship role focused on research and quantitative analysis.**
- **AQR Arbitrage - 2027 Research Summer Analyst**
  - **Internship role within the Arbitrage group focused on research.**
- **2027 Research and Portfolio Management Engineering Summer Analyst**
  - **Internship role at the intersection of research, portfolio management, and engineering.**
- **2027 Trading Summer Analyst**
  - **Internship role focused on trading activities.**

### [AXQ Capital](https://job-boards.greenhouse.io/axq)
- **2026 秋季实习｜量化研究实习生**
  - **Quantitative research internship for Fall 2026.**
- **「启元计划」2027 暑期实习｜量化开发实习生**
  - **Quantitative developer summer internship for 2027.**
- **「启元计划」2027 暑期实习｜量化研究实习生**
  - **Quantitative research summer internship for 2027.**
- **Quantitative Research Intern (Summer 2027)**
  - **Summer 2027 internship focusing on quantitative research.**
- **Quantitative Research Intern (Year-Round)**
  - **Year-round internship focusing on quantitative research.**

### [Akuna Capital](https:/akunacapital.com/careers/)
- **Quantitative Development & Strategy Intern, Summer 2027**
  - **Internship focused on quantitative development and strategy.**
- **Quantitative Research Intern, Summer 2027**
  - **Internship focused on quantitative research.**
...
- **Quantitative Researcher, Intern (Summer 2027)**
  - **Research-focused quantitative role for students in Chicago or London.**
...
- **Quantitative Developer Intern, Summer 2027**
  - **Internship role based in Boston.**
- **Quantitative Researcher Intern, Summer 2027**
  - **Internship role based in Boston.**

### [Balyasny Asset Management](https://bambusdev.my.site.com/s/)
- **Quantitative Researcher - Multi-Asset Arbitrage (Summer Internship)**
  - **Internship level role, typically requiring strong quantitative skills in multi-asset arbitrage context.**
- **Quantitative Researcher - Risk (Summer Internship)**
  - **Internship level role, focused on risk modeling and quantitative analysis.**
- **Quantitative Researcher - Systematic Strategies (Summer Internship - PhD)**
  - **Internship level, requires PhD level background in systematic research.**
- **Quantitative Researcher - Systematic, Multi-Asset Arbitrage (Summer Internship)**
  - **Internship level role, systematic approach to multi-asset arbitrage.**
- **Quantitative Researcher - Quantitative Strategies (Summer Internship)**
  - **Internship level role focused on quantitative strategies.**
- **Quantitative Researcher - Risk (Summer Internship)**
  - **Internship level role, risk focus.**
- **Quantitative Analyst - Commodities Investment Team (Summer Internship)**
  - **Internship level, focus on commodities investment analysis.**
- **Quantitative Analyst – Commodities Investment Team (Summer Internship)**
  - **Internship level, focus on commodities.**
- **Quantitative Analyst – Macro Investment Team (Summer Internship)**
  - **Internship level, macro investment focus.**
- **Quantitative Analyst - Macro & Commodities Investment Teams (Summer Internship)**
  - **Internship level, focus on macro and commodities.**
- **Quantitative Analyst, Commodities (Seasonal Internship)**
  - **Internship level, commodities focus.**
...
- **Quant Trading Internship - Summer 2027**
  - **Strong quantitative reasoning skills, interest in trading, aptitude for technical/analytical assessment.**
...
- **Quantitative Software Developer Intern**
  - **Proficiency in software development; focus on Systematic Investing.**
- **Machine Learning Researcher - Intern**
  - **Expertise in machine learning; focus on Systematic Investing.**
...
- **Quantitative Analyst, Ph.D. Intern (New York) – Summer 2027**
  - **Ph.D. candidate with strong academic and/or professional achievement.**
- **Proprietary Trading Intern (New York) – Summer 2027**
  - **Unique perspectives; undergraduate or graduate student.**

### [Five Rings](https://fiverings.com/careers/)
- **Summer Intern 2027 - Quantitative Researcher (PhD)**
  - **PhD student, Quantitative Research**
...
- **Trading Intern**
  - **The company provides internship opportunities within the Trading department in Amsterdam and New York offices; candidates are evaluated on their interest in financial markets.**
...
- **Algorithm Development (Quant Research & Trading) PhD Internship – Summer 2027**
  - **Exceptional full-time PhD students, focus on research and implementation of automated trading strategies.**
- **Algorithm Development (Quant Research & Trading) Internship – Summer 2027**
  - **Exceptional full-time students, focus on research and implementation of automated trading strategies.**

### [IMC Financial Markets](https://www.imc.com/us/search-careers?jobTypes=Intern&page=1)
- **Quantitative Trader Intern - Summer 2027**
  - **Internship focused on trading, located in Chicago.**
- **Quantitative Research Intern (PhD) - Summer 2027**
  - **PhD level internship focused on trading, located in Chicago.**
- **Quantitative Research Intern (BS/MS) - Summer 2027**
  - **BS/MS level internship focused on trading, located in Chicago.**

### [JPMorgan Chase & Co.](https://jpmc.fa.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1001/jobs?keyword=summer&location=United+States&locationId=300000000289738&locationLevel=country&mode=location)
- **2027 Markets Summer Analyst Program**
  - **Gain hands-on experience in global markets, supporting Research, Sales, Trading, Structuring & Origination, or Digital Markets.**
- **2027 Markets Summer Analyst Program - Research**
  - **Experience in global markets exploring sophisticated financial solutions across asset classes.**

### [Jane Street](https://www.janestreet.com/join-jane-street/open-roles/?type=internship&location=all-locations)
- **Quantitative Trader**
  - **Strong quantitative and analytical skills required for trading and market research.**
- **Quantitative Researcher**
  - **Advanced degree preferred; strong research capabilities in quantitative finance.**

### [Man Group](https://job-boards.eu.greenhouse.io/mangroup)
- **Quant Researcher Internship**
  - **Internship role focused on quantitative research; suitable for undergraduate/graduate students.**
...
- **2027 Quantitative Developer Intern, New York**
  - **Strong programming skills, typically in C++ or Python.**
...
- **Quantitative Research Internship (2027 Start)**
  - **Internship for Quantitative Research & Machine Learning**
- **Quantitative Trading Internship (2027 Start)**
  - **Internship for Trading department**
- **Quantitative Research Internship, Bachelor or Master (Summer 2027 - Shanghai)**
  - **Bachelor or Master degree level internship in Quantitative Research & Machine Learning**
- **Quantitative Trading Internship (Summer 2027 - Shanghai)**
  - **Internship for Trading department**
- **Quantitative Intern (Summer 2027)**
  - **Internship for Trading department in Austin**
...
- **Quantitative Technologist (C++ Intern)**
  - **C++ development skills focusing on research technology and trading systems.**

### [Squarepoint Capital](https://www.squarepoint-capital.com/open-opportunities?lvl=Internship)
- **Intern Quant Researcher**
  - **Available for Investment division, positions open in London, Paris, New York, Singapore, and Hong Kong.**
...
- **AI Research Scientist - Intern [2027 Summer]**
  - **Quantitative Research focused internship**
...
- **2027 Internship - Quantitative Strategist**
  - **Strong quantitative and analytical background.**
- **2027 Internship - Quantitative Trading**
  - **Strong quantitative, mathematical, and programming skills.**
...
- **Quantic - PhD Quantitative Researcher Intern (Summer 2027)**
  - **PhD student, research-focused quantitative skills**
- **Quantic – Quantitative Developer Intern (Summer 2027)**
  - **Software development and quantitative analysis skills**

### [WorldQuant](https://job-boards.greenhouse.io/worldquant)
- **Quant Developer Intern**
  - **Internship focusing on quantitative development tasks.**
- **Quantitative Research Internship 2027**
  - **Quantitative research position targeting 2027 graduation cohorts.**
- **Quantitative Research Intern**
  - **Research-focused internship in quantitative finance.**
- **Quantitative Research Intern (LLMs & AI Agents)**
  - **Research internship focused on LLMs and AI agent development.**
