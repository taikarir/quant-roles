...
- **2027 Research and Portfolio Management Engineering Summer Analyst**
  - **University student with strong engineering and quantitative research capabilities.**
- **2027 Quantitative Prediction Markets Research Summer Analyst**
  - **University student with a strong background in quantitative research and prediction markets.**
- **AQR Arbitrage - 2027 Research Summer Analyst**
  - **University student with quantitative research skills focused on arbitrage strategies.**
- **2027 Research Summer Analyst**
  - **University student with strong quantitative and analytical research skills.**

### [AXQ Capital](https://job-boards.greenhouse.io/axq)
- **2026 秋季实习｜量化研究实习生**
  - **Quantitative research internship role for students.**
- **「启元计划」2027 暑期实习｜量化开发实习生**
  - **Quantitative developer summer internship for 2027 graduates.**
- **「启元计划」2027 暑期实习｜量化研究实习生**
  - **Quantitative research summer internship for 2027 graduates.**
- **Quantitative Research Intern (Summer 2027)**
  - **Summer internship focusing on quantitative research.**
...
- **Quantitative Development & Strategy Intern, Summer 2027**
  - **Focus on quantitative development and strategy, specific requirements not listed.**
- **Quantitative Research Intern, Summer 2027**
  - **Focus on quantitative research, specific requirements not listed.**
...
- **Quantitative Researcher, Intern (Summer 2027)**
  - **Internship role based in Chicago or London.**
...
- **Quantitative Analyst – Commodities Investment Team (Summer Internship)**
  - **Quantitative analysis focused on Commodities.**
- **Quantitative Researcher - Quantitative Strategies (Summer Internship)**
  - **Quantitative Research for Quantitative Strategies.**
- **Quantitative Analyst - Macro & Commodities Investment Teams (Summer Internship)**
  - **Quantitative analysis, Macro and Commodities.**
- **Quantitative Researcher - Risk (Summer Internship)**
  - **Quantitative Research focused on risk.**
- **Quantitative Analyst – Macro Investment Team (Summer Internship)**
  - **Quantitative analysis, Macro focus.**
- **Quantitative Analyst - Commodities Investment Team (Summer Internship)**
  - **Quantitative analysis, Commodities focus.**
...
- **Quantitative Analytics Associate Off Cycle Internship 2027 Singapore**
  - **Targeting quantitative/analytical degree backgrounds; focus on risk and analytics.**
...
- **Quantitative Finance Associate Off Cycle Internship Programme 2027 London**
  - **Targeting quantitative/finance academic backgrounds; focus on quantitative modeling.**
- **Quantitative Finance Associate Summer Internship Program 2027 New York**
  - **Targeting graduate students in quantitative disciplines (Mathematics, Physics, Financial Engineering, etc).**
- **Quantitative Analytics Associate Off Cycle Internship 2027 Hong Kong**
  - **Targeting quantitative/analytical degree backgrounds.**

### [Chicago Trading Company](https://www.chicagotrading.com/campus#search-results)
- **Quant Trading Internship - Summer 2027**
  - **Strong quantitative reasoning skills, participation in Quant Curriculum, and ability to complete technical assessments.**
...
- **Quantitative Alpha Researcher Intern**
  - **Focus on Systematic Investing; requires strong quantitative and research skills.**
- **Quantitative Researcher - Intern**
  - **Focus on Systematic Investing; requires advanced degree (typically PhD or Masters) in STEM field and programming proficiency.**
- **Summer 2027 Quantitative Researcher Internship**
  - **Focus on Systematic Investing; involves financial modeling and data analysis.**
- **Quantitative Software Developer Intern**
  - **Focus on Systematic Investing; strong C++, Python, and data structures skills required.**

### [The D. E. Shaw group](https://www.deshaw.com/careers/internships)
- **Quantitative Analyst Intern (New York) – Summer 2027**
  - **Strong academic/professional achievement; background in quantitative analysis.**
- **Quantitative Analyst, Ph.D. Intern (New York) – Summer 2027**
  - **Ph.D. candidate; strong academic/professional achievement; expertise in quantitative research.**
- **Proprietary Trading Intern (New York) – Summer 2027**
  - **Unique perspectives; interest in trading and financial markets.**
...
- **Algorithm Development (Quant Research & Trading) Internship – Summer 2027**
  - **Full-time students with a focus on research and implementation of automated trading strategies.**
...
- **Quantitative Research Intern (PhD) - Summer 2027**
  - **Internship role in trading, PhD level.**
- **Quantitative Research Intern (BS/MS) - Summer 2027**
  - **Internship role in trading, BS/MS level.**
...
- **2027 Markets Summer Analyst Program**
  - **The program supports Research, Sales, Trading, Structuring & Origination, or Digital Markets, which are standard paths for Quantitative Trader/Researcher interns.**
...
- **Quant Researcher Internship**
  - **Quantitative Research focused; details provided on careers portal.**
...
- **2027 Quantitative Researcher Intern, Austin**
  - **Internship for 2027; Trading department.**
...
- **2027 Shanghai Performance Researcher Summer Internship**
  - **Quantitative research and trading performance analysis**
...
- **Quantitative Technologist (C++ Intern)**
  - **Proficiency in C++ for trading systems and research technology.**

### [Squarepoint Capital](https://www.squarepoint-capital.com/open-opportunities?lvl=Internship)
- **Intern Quant Researcher**
  - **Targeting students for quantitative research internship roles across global offices.**
...
- **Quantitative Strategy Developer Internship: Summer 2027 (Dublin)**
  - **Software Engineering, Quantitative Strategy**
...
- **Quantitative Trader Intern**
  - **Passion for markets, competitive nature, willingness to learn, mathematical modeling.**
- **Algorithmic Trader Intern**
  - **Proficiency in C++, Linux scripting, strong understanding of computing, mathematics, and probability.**
...
- **Quantic - PhD Quantitative Researcher Intern (Summer 2027)**
  - **PhD student, strong quantitative and research background.**
- **Quantic – Quantitative Developer Intern (Summer 2027)**
  - **Strong programming and software development skills relevant to quantitative trading.**

### [WorldQuant](https://job-boards.greenhouse.io/worldquant)
- **Quant Developer Intern**
  - **Quantitative development internship role based in Singapore.**
- **Quantitative Research Internship 2027**
  - **Research division internship role based in Paris.**
- **Quantitative Research Intern**
  - **Quantitative research internship role based in Beijing or Shanghai.**
- **Quantitative Research Intern (LLMs & AI Agents)**
  - **Quantitative research internship focusing on LLMs and AI Agents based in Hanoi or Ho Chi Minh City.**
